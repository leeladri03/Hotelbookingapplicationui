...
export default function AddHotelModal({ onClose, onAdd }: AddHotelModalProps) {
      ...
      <div className="bg-white rounded-xl max-w-2xl w-full shadow-2xl">
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-start justify-between">
            <div>
              <h2 className="text-[#0D7144] mb-1">Add New Hotel</h2>
              <p className="text-gray-600">Register a new hotel in the system</p>
            </div>
            <button
              onClick={onClose}
